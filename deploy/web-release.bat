...
powershell.exe -NoProfile -ExecutionPolicy Bypass -Command ^
  "$path = '%ENV_FILE%';" ^
  "$required = @('NEXT_SERVER_ACTIONS_ENCRYPTION_KEY','NEXT_PUBLIC_SUPABASE_URL','NEXT_PUBLIC_SUPABASE_PUBLISHABLE_OR_ANON_KEY','SUPABASE_SECRET_KEY','DASHSCOPE_API_KEY','WQN_ESP32_AI_PUBLIC_BASE_URL','WQN_ESP32_AI_AUDIO_URL_SECRET','STEP_API_KEY','WQN_REALTIME_PROXY_SECRET','WQN_INTERNAL_API_BASE');" ^
